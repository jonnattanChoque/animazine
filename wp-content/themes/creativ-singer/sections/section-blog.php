...
?>
<?php 
	$blog_section_title    = creativ_singer_get_option( 'blog_section_title' );
	$blog_category = creativ_singer_get_option( 'blog_category' );
	$blog_number	= creativ_singer_get_option( 'blog_number' );
?> 
		    	...
		    	<div class="post-item">
			      	<?php if(has_post_thumbnail()):?>
				        <div class="featured-image">
				        	<a href="<?php the_permalink();?>"><?php the_post_thumbnail('creativ-singer-blog');?></a>  
				        </div>
			    	<?php endif?>
			    	...
			    	<div class="entry-container">
				        ...
				        <div class="entry-content">
		 				    <?php
								$excerpt = creativ_singer_the_excerpt( 20 );
