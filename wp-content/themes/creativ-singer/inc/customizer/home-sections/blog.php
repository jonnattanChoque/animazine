...
$wp_customize->add_section( 'section_home_blog',
	array(
		'title'      => __( 'Blog Section', 'creativ-singer' ),
		'priority'   => 100,
...
$wp_customize->add_control('theme_options[disable_blog_section]', 
	array(		
	'label' 	=> __('Disable Blog Section', 'creativ-singer'),
...
$wp_customize->add_control('theme_options[blog_section_title]', 
	...
	'active_callback' => 'creativ_singer_blog_active',		
	'type'        => 'text'
	)
);
...
$wp_customize->add_control( 'theme_options[blog_number]',
	array(
		'label'       => __( 'Number of Posts', 'creativ-singer' ),
		'description' => __('Maximum number of post to show is 6.', 'creativ-singer'),
		'section'     => 'section_home_blog',
		'active_callback' => 'creativ_singer_blog_active',		
		'type'        => 'number',
		'priority'    => 100,
...
$wp_customize->add_control(
	new creativ_singer_Dropdown_Taxonomies_Control( $wp_customize, 'theme_options[blog_category]',
		array(
		'label'    => __( 'Select Category', 'creativ-singer' ),
		'section'  => 'section_home_blog',
