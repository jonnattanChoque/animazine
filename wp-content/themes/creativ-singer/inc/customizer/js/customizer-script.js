...
*/
 jQuery(document).ready(function($) {
    $('#customize-control-theme_options-layout_options_blog #creativ-singer-img-container li label img').click(function(){    	
        $('#customize-control-theme_options-layout_options_blog #creativ-singer-img-container li').each(function(){
            $(this).find('img').removeClass ('creativ-singer-radio-img-selected') ;
        });
        $(this).addClass ('creativ-singer-radio-img-selected') ;
    });  

    $('#customize-control-theme_options-layout_options_archive #creativ-singer-img-container li label img').click(function(){    	
        $('#customize-control-theme_options-layout_options_archive #creativ-singer-img-container li').each(function(){
            $(this).find('img').removeClass ('creativ-singer-radio-img-selected') ;
        });
        $(this).addClass ('creativ-singer-radio-img-selected') ;
    });  

    $('#customize-control-theme_options-layout_options_page #creativ-singer-img-container li label img').click(function(){    	
        $('#customize-control-theme_options-layout_options_page #creativ-singer-img-container li').each(function(){
            $(this).find('img').removeClass ('creativ-singer-radio-img-selected') ;
        });
        $(this).addClass ('creativ-singer-radio-img-selected') ;
    });  

    $('#customize-control-theme_options-layout_options_single #creativ-singer-img-container li label img').click(function(){    	
        $('#customize-control-theme_options-layout_options_single #creativ-singer-img-container li').each(function(){
            $(this).find('img').removeClass ('creativ-singer-radio-img-selected') ;
        });
        $(this).addClass ('creativ-singer-radio-img-selected') ;
    });         
